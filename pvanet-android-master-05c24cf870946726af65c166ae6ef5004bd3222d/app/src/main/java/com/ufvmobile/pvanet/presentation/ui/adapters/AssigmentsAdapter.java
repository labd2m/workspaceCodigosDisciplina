 ...
 */
public class AssigmentsAdapter extends RecyclerView.Adapter<AssigmentsAdapter.MyViewHolder>  {
    ...
    public AssigmentsAdapter(Context context, ArrayList<Schedule> calendar) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(schedule.getAssigments().isEmpty()) {
        ...
        for(String content : schedule.getAssigments()) {
